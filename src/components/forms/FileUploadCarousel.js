...
const FileUploadCarousel = ({values, setValues, setLoading}) => {
  ...
  return (
    <div className='my-2'>
      ...
      <div className="rounded-md my-2">
          ...
          <input type="file" onChange={fileUploadAndResize} multiple hidden accept='images/*' placeholder="Quantity" className="relative block px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm" />
      </div>
    </div>
  )
}
