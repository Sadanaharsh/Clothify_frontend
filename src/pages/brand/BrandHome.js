...
import {getCategories, getCategoryById} from '../../functions/category'
import {getSubs, getSubsByCategory} from '../../functions/sub'
        ...
        <div className='flex'>
            ...
            <div className='col-span-3'>
                <div className='mx-6 mt-4'>
                    {loading ? <h4 className='text-red-600 text-2xl font-bold'>Loading...</h4> : <h4 className='text-2xl font-bold'>{brand.name}</h4>}
